...
library(readr)
library(dplyr)
ppp_removed_ga <- read_excel("Data Analytics L3_ Paycheck Protection Program - UMD Journalism/Data_PPP/ppp-removed-ga.xlsx", 
...
ppp_applicants_ga_full <- read_csv("Data Analytics L3_ Paycheck Protection Program - UMD Journalism/Data_PPP/ppp_applicants_ga_full.csv", 
